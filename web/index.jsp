...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="styleindex/img/core-img/favicon.ico">

    <!-- Core Stylesheet -->
    <link href="styleindex/style.css" rel="stylesheet">
...
<body>
                        ...
                        <nav class="navbar navbar-expand-lg navbar-light">
                            ...
                            <div class="collapse navbar-collapse" id="ca-navbar">
                                ...
                                if( username.equals("null") ){
                                    out.write("<div class='sing-up-button d-lg-none'>"
                                            +"<a href='#'>"+"Log in"+"</a>"
                                            +"</div>");
                                } %>
    ...
    <section class="wellcome_area clearfix" id="home">
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12 col-md">
                    ...
                    <div class="get-start-area">
                        <!-- Form Start -->
                        <form action="PrenezRendezVous" method="post" class="form-inline">
                            <input type="submit" class="submit" value="Prenez rendez-vous">
                        </form>
                        <!-- Form End -->
                    </div>
                </div>
        ...
        <div class="welcome-thumb wow fadeInDown" data-wow-delay="0.5s">
            <img src="styleindex/img/bg-img/welcome-img.png" alt="">
        </div>
    </section>
    <!-- ***** Wellcome Area End ***** -->
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="special_description_img">
                            <img src="styleindex/img/bg-img/special.png" alt="">
                        </div>
                    </div>
                ...
                <div class="col-12">
                    ...
                    <div class="app_screenshots_slides owl-carousel">
                        <div class="single-shot">
                            <img src="styleindex/img/scr-img/app-1.jpg" alt="">
                        </div>
                        <div class="single-shot">
                            <img src="styleindex/img/scr-img/app-2.jpg" alt="">
                        </div>
                        <div class="single-shot">
                            <img src="styleindex/img/scr-img/app-3.jpg" alt="">
                        </div>
                        <div class="single-shot">
                            <img src="styleindex/img/scr-img/app-4.jpg" alt="">
                        </div>
                        <div class="single-shot">
                            <img src="styleindex/img/scr-img/app-5.jpg" alt="">
                        </div>
                        <div class="single-shot">
                            <img src="styleindex/img/scr-img/app-3.jpg" alt="">
                        </div>
                ...
                <div class="col-12 col-md-6 col-lg-5">
                    <div class="slider slider-nav">
                        <div class="client-thumbnail">
                            <img src="styleindex/img/bg-img/client-3.jpg" alt="">
                        </div>
                        <div class="client-thumbnail">
                            <img src="styleindex/img/bg-img/client-2.jpg" alt="">
                        </div>
                        <div class="client-thumbnail">
                            <img src="styleindex/img/bg-img/client-1.jpg" alt="">
                        </div>
                        <div class="client-thumbnail">
                            <img src="styleindex/img/bg-img/client-2.jpg" alt="">
                        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-3">
                    <div class="single-team-member">
                        <div class="member-image">
                            <img src="styleindex/img/team-img/team-1.jpg" alt="">
                ...
                <div class="col-12 col-md-6 col-lg-3">
                    <div class="single-team-member">
                        <div class="member-image">
                            <img src="styleindex/img/team-img/team-2.jpg" alt="">
                            <div class="team-hover-effects">
                                <div class="team-social-icon">
                                    <a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                    <a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                ...
                <div class="col-12 col-md-6 col-lg-3">
                    <div class="single-team-member">
                        <div class="member-image">
                            <img src="styleindex/img/team-img/team-3.jpg" alt="">
                            <div class="team-hover-effects">
                                <div class="team-social-icon">
                                    <a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                    <a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                ...
                <div class="col-12 col-md-6 col-lg-3">
                    <div class="single-team-member">
                        <div class="member-image">
                            <img src="styleindex/img/team-img/team-4.jpg" alt="">
                            <div class="team-hover-effects">
                                <div class="team-social-icon">
                                    <a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                    <a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a>
    ...
    <!-- Jquery-2.2.4 JS -->
    <script src="styleindex/js/jquery-2.2.4.min.js"></script>
    <!-- Popper js -->
    <script src="styleindex/js/popper.min.js"></script>
    <!-- Bootstrap-4 Beta JS -->
    <script src="styleindex/js/bootstrap.min.js"></script>
    <!-- All Plugins JS -->
    <script src="styleindex/js/plugins.js"></script>
    <!-- Slick Slider Js-->
    <script src="styleindex/js/slick.min.js"></script>
    <!-- Footer Reveal JS -->
    <script src="styleindex/js/footer-reveal.min.js"></script>
    <!-- Active JS -->
    <script src="styleindex/js/active.js"></script>
</body>
